...
var (
	pattern_Account_Login_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"libra", "ptapi", "v1", "account", "login"}, "", runtime.AssumeColonVerbOpt(true)))
)
